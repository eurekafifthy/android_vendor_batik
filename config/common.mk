...
PRODUCT_COPY_FILES += \
    ...
    vendor/batik/prebuilt/common/bin/50-batik.sh:system/addon.d/50-batik.sh \
    vendor/batik/prebuilt/common/bin/blacklist:system/addon.d/blacklist

ifeq ($(AB_OTA_UPDATER),true)
PRODUCT_COPY_FILES += \
    vendor/batik/prebuilt/common/bin/backuptool_ab.sh:system/bin/backuptool_ab.sh \
    vendor/batik/prebuilt/common/bin/backuptool_ab.functions:system/bin/backuptool_ab.functions \
    vendor/batik/prebuilt/common/bin/backuptool_postinstall.sh:system/bin/backuptool_postinstall.sh
endif

ifneq ($(TARGET_BUILD_VARIANT),user)
# userinit support
PRODUCT_COPY_FILES += \
    vendor/batik/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit
endif
