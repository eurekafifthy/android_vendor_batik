...
ALARM_PATH := vendor/batik/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/batik/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/batik/prebuilt/common/media/audio/ringtones
