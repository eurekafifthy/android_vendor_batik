...
custom_local_manifest = ".repo/local_manifests/batik_manifest.xml"
custom_default_revision = "13"
custom_dependencies = "batik.dependencies"
org_manifest = "BatikOS-Devices"  # leave empty if org is provided in manifest
org_display = "BatikOS-Devices"  # needed for displaying
